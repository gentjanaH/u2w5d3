package gentjanahani.u2w5d3.runners;


import gentjanahani.u2w5d3.U2w5d3Application;
...
public class MyRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(U2w5d3Application.class);
        System.out.println("****************************");
